        ...
        <div className='mt-[120px] items-center flex justify-center w-full flex-col'>
            <div className='md:w-[60%] w-full my-[20px] rounded-[12px] pt-[20px] pb-[30px] px-[5px] bg-primary border-[5px] border-secondary '>
                ...
                <div className='flex justify-center items-center flex-col md:w-[80%] w-full text-center mx-auto px-[5px]'>
                    ...
                    <p className='text-[1rem] break-words'>By using votenow-crypto.com you agree to the following Terms of Service. The use of "we" on this page refers to the site and company (Vote Now Crypto) and the use of the pronoun "you" refers to all visitors and users. If you do not agree to any of these terms please discontinue using votenow-crypto.com</p>
                    ...
                    <p className='text-[1rem] break-words'>You are only allowed to add a coin to votenow-crypto.com if you are the owner of the coin or if you have been given explicit permission by the owner. You can only create one location for the same coin, multiple locations will be deleted. However you have permission to add 3 different coins maximum. To increase this limit, please <span onClick={() => navigate("/contact")} className="text-hover font-bold cursor-pointer">contact us</span></p>
                    <p className='text-[1rem] break-words'>Once a coin has been added, you agree that votenow-crypto.com may make regular attempts to collect and store your coin data and display it on our website.
                    ...
                    <p className='text-[1rem] break-words'>votenow-crypto.com reserves the right to remove any coin at any time with or without notice.

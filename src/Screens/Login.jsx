      ...
      <div className='mt-[120px] flex items center justify-center'>
          <div className='lg:w-[50%] md:w-[80%] w-full pt-[20px] pb-[30px] px-[10px] bg-[#262626] border-[5px] border-primary '>
              ...
              <div className='mt-[20px] flex flex-col gap-y-[18px] items-center'>
                  ...
                  <p className='text-primary hover:text-white cursor-pointer'>Forgot Password?</p>
                  <p className='text-red-500 mt-[8px]'>{error}</p>
                  
                  <button onClick={loginHandle} className='border border-primary py-[6px] px-[50px] bg-[#262626] text-[15px] h-[35px] whitespace-nowrap align-middle rounded-[4px] hover:text-background hover:bg-primary'>
                      Login
                  </button>
                  <p className=''>
                      Do not have an Account?
                      <span onClick={() => navigate("/register")} className='text-primary cursor-pointer ml-[5px] hover:border-b hover:border-b-primary pb-[4px]'>
                          Register
                      </span>
                  </p>
              </div>

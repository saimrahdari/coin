  ...
  return (
    <div className='mt-[120px] items-center flex justify-center w-full flex-col'>
      ...
      <div className='w-full flex mt-[20px] px-[8px] md:w-[80%] flex-col'>
        ...
        <div
          className={`mt-[18px] w-[65px] h-[30px] rounded-full px-1 border-[2px] border-primary ${isOn ? "bg-primary" : "bg-hover"} transition-all duration-300 ease-in-out`}
          onClick={() => setIsOn(!isOn)}
        >
          <div
            className={`m-0 p-0 w-[28px] h-[28px] rounded-full ${isOn ? "bg-white" : "bg-white"
              } shadow-md transform ${isOn ? "translate-x-[32px]" : "-translate-x-1"
        ...
        <div className='flex flex-col gap-y-5 mt-[18px]'>

          {
            partnerData.map(partner => (
              <div className='relative border-[2px] border-secondary bg-primary rounded-[5px] p-[2rem]'>
                ...
                <div className='absolute bottom-[-15px] left-1/2 bg-hover text-primary py-[3px] px-[10px] rounded-[5px] cursor-pointer' style={{ transform: "translateX(-50%)" }}>
                  More Details
                </div>
                ...
                <div className='flex flex-row flex-wrap'>
                  ...
                  <div className='md:w-[25%] w-full'>
                    ...
                    <button className='w-full font-medium ml-[5px] text-secondary text-[14.5px] py-[10px] px-[15px] rounded-[8px]' style={{ lineHeight: '20px', animation: 'shadow-pulse 3s infinite', background: "linear-gradient(180deg,white 0, white" }}>
                      Request Service
                    </button>
                  </div>

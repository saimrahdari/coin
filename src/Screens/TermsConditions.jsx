        ...
        <div className='mt-[120px] items-center flex justify-center w-full flex-col'>
            <div className='md:w-[80%] w-full my-[20px] rounded-[12px] pt-[20px] pb-[30px] px-[5px] bg-primary border-[5px] border-secondary '>
                ...
                <div className='flex justify-center items-center flex-col md:w-[80%] w-full text-center mx-auto px-[5px]'>
                    ...
                    <p className='text-[1rem] break-words'>The present general conditions of sale are concluded between Vote Now Crypto and any non-trading individual wishing to make a temporary "Premium" on the website votenow-crypto.com</p><br />
                    ...
                    <p className='text-[1rem] break-words'>General terms and conditions of sale for products sold on the votenow-crypto.com website</p>
                    <h1 className='font-bold text-[1.5rem] mt-[20px] mb-[10px]'>JOB</h1>
                    <p className='text-[1rem] break-words'>The General Terms and Conditions of Sale are intended to define the terms and conditions of sale between Vote Now Crypto and the User, starting with the act of purchasing a temporary advertising space for a period of time determined by the User on votenow-crypto.com</p>
                    <h1 className='font-bold text-[1.5rem] mt-[20px] mb-[10px]'>PRODUCTS</h1>
                    <p className='text-[1rem] break-words'>The products governed by these Terms and Conditions are temporary advertising slots provided to users of votenow-crypto.com by displaying on the homepage of their votenow-crypto.com/coin for a limited time chosen at the time of purchase.</p>
                    <h1 className='font-bold text-[1.5rem] mt-[20px] mb-[10px]'>RATES</h1>
                    <p className='text-[1rem] break-words'>The prices of our items are displayed on the store at the time of payment. They are indicated including all taxes. votenow-crypto.com reserves the right to modify its prices at any time.</p>
                    <h1 className='font-bold text-[1.5rem] mt-[20px] mb-[10px]'>ORDERING</h1>
                    <p className='text-[1rem] break-words'>To place an order, the User does not need to identify himself on the site and therefore to have created an account, he must go through the Registration page, then Login, where he will be able to consult the Premium page indicating the waiting list (potential) of the coins that have purchased a display at the top of the list on votenow-crypto.com</p><br />
                    ...
                    <p className='text-[1rem] break-words'>votenow-crypto.com will not be held responsible if a featured coin encounters a problem during the time of its advertising.</p><br />
                    ...
                    <p className='text-[1rem] break-words'>votenow-crypto.com guarantees 90% availability of your ad. If votenow-crypto.com encounters technical problems beyond its control that make it impossible for the advertisement to be displayed on a coin's top listing, you may agree to compensation based on the duration of the interruption:</p><br />
